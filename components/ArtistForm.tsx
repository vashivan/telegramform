  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 max-w-xl justify-center items-center w-full">
      ...
      <p className="text-gray-500 self-start text-sm">
        Click on the button below to upload your portrait or headshot. One good photo is enough.
      </p>
      <input
        name="photo"
        type="file"
        accept="image/*"
        className="bg-pink-800 p-2 w-full mb-5 cursor-pointer text-white flex items-center rounded-lg"
      />
